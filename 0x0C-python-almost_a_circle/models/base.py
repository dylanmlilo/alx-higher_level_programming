...
class Base:
    ...
    def load_from_file(cls):
        ...
        with open(filename, mode='r', encoding='utf-8') as jsonfile:
            objs = cls.from_json_string(jsonfile.read())
            instances = []
            for elem in objs:
    ...
    def save_to_file_csv(cls, list_objs):
        ...
        with open(filename, "w", newline="") as csvfile:
            if list_objs is None or list_objs == []:
                ...
                csvWriter = csv.DictWriter(csvfile, keyNames=keyNames)
                for obj in list_objs:
                    csvWritewriter.writerow(obj.to_dictionary())
        ...
        try:
            with open(filename, "r", newline="") as csvfile:
                if cls.__name__ == "Rectangle":
                    ...
                    keyNames = ["id", "size", "x", "y"]
                list_dicts = csv.DictReader(csvfile, keyNames=keyNames)
